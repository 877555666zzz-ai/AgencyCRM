...
/* ============================================================================
   Blocked — экран, который показывается, когда:
   - компания выключена (reason="inactive")
   - подписка истекла (reason="expired")
   - пользователь не привязан к компании (reason="no-company")
   ============================================================================ */
